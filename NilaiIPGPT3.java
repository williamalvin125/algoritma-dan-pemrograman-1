...
public class NilaiIPGPT3 {
    public static void main(String[] args) {
        ...
        System.out.println("=====================================================");
        System.out.println("Mata Kuliah \t SKS \t Nilai Huruf \t IP \t\t SKS * IP");
        System.out.println("=====================================================");
        ...
        for (int a = 0; a < jumlahmatkul; a++) {
            ...
            System.out.println(
                    inputkode[a][0] + "\t\t\t" + inputsks[a][1] + "\t\t" + inputhuruf[a][2] + "\t\t" + ip + "\t\t"
                            + (ipMataKuliah * sksMataKuliah));
        }
    }
}